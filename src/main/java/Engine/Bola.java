...
public class Bola extends Circle{
    ...
    public Bola(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
        ...
        if (type.equals("box")){
            createBox();
        }else if (type.equals("sphere half") || type.equals("sphere")){
            createSphere(type);
